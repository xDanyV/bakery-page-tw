            ...
            <div className="mt-20 max-w-6xl w-full text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                    ...
                    <div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                        <img src="/images/employee.jpg" alt="Chef Ana" className="w-32 h-32 mx-auto rounded-full object-cover mb-4" />
                    ...
                    {/* Miembro 2 */}
                    <div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                        <img src="/images/employee_1.jpg" alt="Carlos López" className="w-32 h-32 mx-auto rounded-full object-cover mb-4" />
                    ...
                    {/* Miembro 3 */}
                    <div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                        <img src="/images/employee_2.jpg" alt="Laura Méndez" className="w-32 h-32 mx-auto rounded-full object-cover mb-4" />
